          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              <ul className="list-disc pl-5 space-y-2 mb-4">
                <li>
                  <strong>Monday:</strong> 30-minute painting session focusing on process rather than outcome
                </li>
                <li>
                  <strong>Wednesday:</strong> Genealogy research session connecting to your heritage and broader context
                </li>
                <li>
                  <strong>Friday:</strong> Reading session with Black literature that resonates with your personal
                  journey
                </li>
                <li>
              ...
              <p>
                ...
                serve as reminders of your unique value and perspective.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <p className="mb-4">
                ...
                Nurture this dynamic through practices that balance depth with practical application.
              </p>
              ...
              <div className="bg-gray-50 p-4 rounded-md border border-gray-200 mb-4">
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>
                    Select a technical concept relevant to your target role (like an aspect of curriculum development)
                  </li>
                  ...
                  <li>Identify one practical application that highlights your unique approach</li>
                </ol>
              </div>

              <p>
                This practice helps you leverage your Four's depth and your Five's analytical thinking, transforming
                abstract concepts into expressions of your unique technical perspective.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <p className="mb-4">
                ...
                needs through practices that honor both solitude and meaningful connection.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      Allocate specific time blocks for deep research into Intuit's products and educational approaches
                    </li>
                    <li>Set clear boundaries around research time to prevent endless exploration</li>
                    <li>Focus on depth rather than breadth, fully understanding key concepts</li>
                    <li>Connect research to practical applications and authentic expression</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      Identify 3-5 potential networking connections at Intuit based on genuine interest and alignment
                    </li>
                    <li>Prepare for conversations by considering how your unique perspective might add value</li>
                    <li>
              ...
              <p>
                ...
                contribute to your job search effectiveness.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            milestones={[
              {
                ...
                tasks: [
                  ...
                  { name: "Create reading list of Black literature that resonates with you", completed: false },
              ...
              },
              {
                ...
                tasks: [
                  { name: "Define specific research time blocks in your calendar", completed: false },
                  { name: "Identify 3-5 potential networking connections at Intuit", completed: false },
